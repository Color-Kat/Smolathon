...
const Kon = new Unit({
    ...
    bonusDescription: 'Получите вдвое больше очков за город, окруженный Cмоленской крепостной стеной, построенной под руководством Фёдора Коня!',
